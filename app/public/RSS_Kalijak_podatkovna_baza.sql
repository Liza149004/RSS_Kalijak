DROP DATABASE IF EXISTS RSS_Kalijak;
...
CREATE USER 'readonly'@'127.0.0.1' IDENTIFIED BY '';
...
CREATE TABLE naslov(
    ...
    naslov VARCHAR(145) NOT NULL,	
	TK_posta INT NOT NULL,
    FOREIGN KEY(TK_posta) REFERENCES posta(ID_posta)
);
...
CREATE TABLE nacin_placila(
    ...
    st_kartice BIGINT(16) NOT NULL,
    datum_poteka VARCHAR(45) NOT NULL,
    CVV INT(3) NOT NULL
);
...
INSERT INTO naslov (naslov, TK_posta) VALUES
('Trg mladosti 12', 5),
...
INSERT INTO kupec (ime, priimek, email, telefonska_st, TK_naslov, Tk_nacin_placila) VALUES
('Ana', 'Novak', 'ana.novak@gmail.com', '036458995', 1, 2),
('Matej', 'Kovač', 'matej.kovaček@gmail.com', '056335968', 2, 3),
('Miha', 'Horvat', 'horvat.miha@gmail.com', '033489678', 3, 5),
('Luka', 'Zupančič', 'neotonzupancic@gmail.com', '015689447', 4, 1),
('Klavdija', 'Želon', 'klavdek@gmail.com', '078644593', 5, 4);
