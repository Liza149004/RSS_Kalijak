    ...
    <head>
        ...
        <?php include 'header_svetlo.php'; ?>
                ...
                <div class="toggle-container">
                    <button class="toggle-button active" onclick="window.location.href='trgovina_sadike.php'">Sadike</button>
                    <button class="toggle-button" onclick="window.location.href='trgovina_zelenjava.php'">Zelenjava</button>
                </div>
